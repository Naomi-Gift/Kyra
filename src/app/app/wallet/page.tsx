...
export default function WalletPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      {/* Header */}
      <div>
        <h1 className="font-serif text-2xl font-bold text-white">Wallet</h1>
      ...
      <div className="glass rounded-2xl p-5 space-y-3">
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={a.group} className="flex items-center justify-between py-2 border-b border-white/5 last:border-0">
